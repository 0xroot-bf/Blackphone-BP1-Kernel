...
static int __devinit tlv320aic325x_spi_probe(struct spi_device *spi)
{
...
static int __devexit tlv320aic325x_spi_remove(struct spi_device *spi)
{
...
static struct spi_driver aic325x_spi_driver = {
	...
	.remove		= __devexit_p(tlv320aic325x_spi_remove),
