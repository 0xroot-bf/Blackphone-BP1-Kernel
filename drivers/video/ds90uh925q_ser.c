...
static int __devinit ds90uh925q_probe(struct i2c_client *client,
...
static int __devexit ds90uh925q_remove(struct i2c_client *client)
{
	struct ds90uh925q_rec *data = i2c_get_clientdata(client);
...
static struct i2c_driver ds90uh925q_driver = {
	...
	.remove   = __devexit_p(ds90uh925q_remove),
